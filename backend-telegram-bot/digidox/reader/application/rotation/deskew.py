...
def determine_skew_dev(image: np.ndarray, sigma: float = 3.0, num_peaks: int = 20) -> Tuple[Optional[float], Any, Any, Tuple[Any, Any, Any]]:
    img = image
    ...
    return angle, angles, average_deviation, (out, angles, distances)
